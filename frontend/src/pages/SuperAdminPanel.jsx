...
import { Shield, Building2, Users, Plus, Trash2, Check, X, Eye, EyeOff, GraduationCap, Search, UserCheck, Hash, ArrowUpCircle, History, AlertTriangle } from 'lucide-react';
          ...
          <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col gap-8 max-w-6xl">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                {currentSession && (
                  <div className="text-xs mt-1 text-slate-500 dark:text-slate-400 font-medium uppercase tracking-wider">Current Session: <span className="font-black text-slate-700 dark:text-white">{currentSession}</span></div>
                )}
              </div>
            </div>
